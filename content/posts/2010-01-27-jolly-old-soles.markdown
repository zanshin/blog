...
<p style="text-align: center;"><a href="https://zanshin.net/images/oldAndNew.png">{{ $image := .ResourceGetMatch "oldAndNew.png" }}
<img src="{{ $image.RelPermalink }}" class="aligncenter size-full wp-image-2245" title="oldAndNew" alt="" width="431" height="326" >
