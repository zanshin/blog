...
link: false
---
After trying to enable <a href="https://zanshin.net/2008/01/30/remote-access/" title="SBC DSL remote access - fail">remote access</a> to my home network and discovering that AT&amp;T doesn't really allow inbound connections, I've resorted to a different solution for access-from-anywhere-version-control.
### Roundhaus
...
{{< highlight bash  >}}$ cd websites{{< / highlight >}}
{{< highlight bash  >}}$ svn import -m "initial import of sites" . https://path-to-roundhaus-project/project/trunk{{< / highlight >}}
...
{{< highlight bash  >}}$ cd sites{{< / highlight >}}
{{< highlight bash  >}}$ svn co https://path-to-roundhaus-project/project/trunk{{< / highlight >}}
